...
func_Aij = model.get_layer("conv2d_6").output
func_grads = K.gradients(func_Yc,func_Aij)[0]
func = K.function([model.input],[func_grads])


# calucurate grad and Aij
wij,Aij= func([x]),copy.deepcopy(x)
wij,Aij = wij[0][0],Aij[0]
...
heatmap = cam
# save
cv2.imwrite("./sample.png",heatmap)
